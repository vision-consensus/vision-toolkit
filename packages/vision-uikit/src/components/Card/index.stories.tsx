...
export const CardHeader: React.FC = () => {
  ...
  const borderBackground = `linear-gradient(${customHeadingColor} ${gradientStopPoint}, '#ddd' '#eee'`;

  // Gradient overlap is also possible, just put the "dividing" gradient first and after that the header gradient
  const gradientBorderColor = `linear-gradient(transparent ${gradientStopPoint}, '#ddd' ${gradientStopPoint}), '#ddd'`;
  return (
    <div style={{ padding: "32px", width: "500px" }}>
      <Row>
      ...
      <Row>
        <Card borderBackground={gradientBorderColor}>
          <Box background={'#000'} p="16px" height={headerHeight}>
